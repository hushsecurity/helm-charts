...
CONNECTOR_UNSUPPORTED_VERSIONS = ["v0.4", "v0.4.0-rc1", "v0.4.0", "v0.5.0-rc1", "rc0.4"]
...
def test_hush_sensor_minimum_supported_version():
    ...
    _test_unsup_vers("sensorTag", SENSOR_UNSUPPORTED_VERSIONS, "v0.25.0")
    _test_sup_vers("sensorTag", SENSOR_SUPPORTED_VERSIONS)

    _test_unsup_vers("connectorTag", CONNECTOR_UNSUPPORTED_VERSIONS, "v0.5.0")
